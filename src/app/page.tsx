    ...
    <main className="min-h-screen bg-[#f7f7f8] flex flex-col items-center justify-start px-4 py-8">
      <div className="w-full max-w-3xl">
        ...
        <div className="mt-4 flex items-center gap-2">
          <input
            className="flex-grow rounded-lg border border-gray-300 px-4 py-3 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black placeholder-black"
